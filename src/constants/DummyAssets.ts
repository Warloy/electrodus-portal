...
export const dummyCompany: TCompany = {
  id: 1,
  name: "Prometheus Solutions",
  vision: "Nuestra visión es ser la empresa de servicios técnicos de referencia en el mercado, elegida por los clientes que buscan soluciones confiables, eficientes y de alta calidad.",
